...
Group.new('Normal', colors.noir_4, colors.bground)
...
Group.new('CursorColumn', nil, colors.noir_8)
...
Group.new('VertSplit', colors.noir_8, colors.noir_8)
...
Group.new('Search', colors.noir_8, groups.ui_sel_bg_1)
Group.new('IncSearch', colors.noir_8, groups.ui_sel_bg_1)
...
Group.new('NvimTreeOpenedFile', colors.noir_0, nil)
Group.new('NvimTreeExecFile', colors.noir_0, nil)
...
Group.new('NvimTreeIndentMarker', colors.noir_5)
