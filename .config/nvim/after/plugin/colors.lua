-- based off https://github.com/jesseleite/nvim-noirbuddy
-- tip: run ":so $VIMRUNTIME/syntax/hitest.vim" to see highlight naming and
-- their set colors. Handy!
...
Group.new("DiffAdd", c.primary, c.gray_6)
Group.new("DiffChange", c.gray_0, c.gray_6)
Group.new("DiffDelete", c.secondary, c.gray_6)
Group.new("DiffText", c.gray_0, c.gray_5)
...
Group.new("NvimTreeCursorLine", c.white, nil, s.bold)
...
Group.new("TelescopeSelection", c.white, nil, s.bold)
